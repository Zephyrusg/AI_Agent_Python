...
schema_write_file = types.FunctionDeclaration(
    name="write_file",
    description="Write file with the provided content in the specified directory, constrained to the working directory.",
    parameters=types.Schema(
        type=types.Type.OBJECT,
        properties={
            "file_path": types.Schema(
...
schema_run_python_file = types.FunctionDeclaration(
    ...
    parameters=types.Schema(
        ...
        properties={
            "file_path": types.Schema(
                type=types.Type.STRING,
                description="The file path to the file to run, relative to the working directory.",
            ),
